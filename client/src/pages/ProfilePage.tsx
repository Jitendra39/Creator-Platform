...
const ProfilePage = ({
    ...
    useEffect(() => {
        ...
        axiosInstance
            .get<{}, { data: PublicUser }>(`/api/accounts/${name}`)
            .then(({ data }) => {
                setUsername(data.username);
                setUser(data);
                            ...
                            <div className="flex sm:flex-row flex-col justify-between">
                                ...
                                <div className="flex flex-col relative mr-[50px] mt-[40px] w-[200px] sm:w-[280px] ml-[50px] sm:ml-0">
                                    ...
                                    <div className="text-[14px] relative">
                                        ...
                                        ></div>
                                        <style>
                                            {`.easy-line::after { width: ${((eSolved || 0) / (eAll || 1)) *
                                                100
                                                }%; }`}
                                            {`.medium-line::after { width: ${((mSolved || 0) / (mAll || 1)) *
                                                100
                                                }%; }`}
                                            {`.hard-line::after { width: ${((hSolved || 0) / (hAll || 1)) *
                                                100
                                                }%; }`}
                                        </style>
                                    </div>
